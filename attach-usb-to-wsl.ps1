...
param(
    [string]$Filter = "STLink|ST-Link|STM32|CMSIS-DAP|Black Magic|STMicroelectronics|USB Serial Device|Virtual COM",
...
if (-not $matches) {
    ...
    Write-Host "  usbipd attach --busid <BUSID> --wsl=$Distro"
    exit 1
}
